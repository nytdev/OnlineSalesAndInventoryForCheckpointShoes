            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('inventory.stock.store') }}" class="space-y-6">
                            ...
                            <select name="product_id" id="product_id" required
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->product_id }}" 
                                        ...
                                        {{ $product->product_name }} - {{ $product->product_brand }} (Current: {{ $product->quantity }})
                                    </option>
                                @endforeach
                            </select>
                            @error('product_id')
                        ...
                        <div id="current-stock-display" class="hidden bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                            <div class="flex items-center">
                        ...
                        <!-- New Quantity -->
                        <div>
                            <label for="new_quantity" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <div id="stock-change-display" class="hidden bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                            <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Used to calculate the total value of this adjustment</p>
                            @error('unit_cost')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select name="reason" id="reason" 
                                ...
                                <option value="Theft or loss" {{ old('reason') == 'Theft or loss' ? 'selected' : '' }}>Theft or loss</option>
                        ...
                        <!-- Movement Date -->
                        <div>
                            <label for="movement_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Movement Date
                            </label>
